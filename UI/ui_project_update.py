...
"padding : 6px;")
        ...
        self.format_2.setAutoFillBackground(False)
        self.format_2.setStyleSheet("font: 10pt \"Montserrat\";")
        self.format_2.setWordWrap(True)
...
"}")
        ...
        self.project_update_btnn = QtWidgets.QPushButton(self.addProject_footer_frame)
        self.project_update_btnn.setMinimumSize(QtCore.QSize(211, 0))
        self.project_update_btnn.setMaximumSize(QtCore.QSize(211, 16777215))
        self.project_update_btnn.setStyleSheet("QPushButton{\n"
"padding : 6px;\n"
...
" }")
        self.project_update_btnn.setObjectName("project_update_btnn")
        self.horizontalLayout_7.addWidget(self.project_update_btnn, 0, QtCore.Qt.AlignHCenter)
    ...
    def retranslateUi(self, TaskJamProjectInfo):
        ...
        self.project_update_btnn.setText(_translate("TaskJamProjectInfo", "GÜNCELLE"))
import image_rc
