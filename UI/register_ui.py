...
"}")
        ...
        self.horizontalLayout_9.setContentsMargins(9, 0, -1, 8)
        self.horizontalLayout_9.setObjectName("horizontalLayout_9")
        self.repassword_label = QtWidgets.QLabel(self.frame_3)
        self.repassword_label.setObjectName("repassword_label")
        self.horizontalLayout_9.addWidget(self.repassword_label, 0, QtCore.Qt.AlignHCenter)
        self.repassword_lineedit = QtWidgets.QLineEdit(self.frame_3)
...
"font: 75 12pt \"MS Shell Dlg 2\";")
        ...
        self.create_btn = QtWidgets.QPushButton(self.button_row_frame)
        ...
        self.verticalLayout_2.addWidget(self.button_row_frame, 0, QtCore.Qt.AlignRight)
