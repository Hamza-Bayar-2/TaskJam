...
"}")
        ...
        self.label_3 = QtWidgets.QLabel(self.header_frame)
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap(":/icons/icons/red_set.png"))
...
"}")
    ...
    def retranslateUi(self, TaskLate):
        ...
        self.label_3.setText(_translate("TaskLate", "Bitmesi Gerekiyor"))
